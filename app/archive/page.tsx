...
type Page = "home" | "method" | "participants" | "participant" | "notice" | "team" | "materials" | "publications" | "systems" | "activity" | "reference" | "ethics" | "memos" | "memo";
...
export default function RecoveredWebsite() {
  ...
  const sectionIsActive = (section: Page) => page === section || (section === "participants" && page === "participant") || (section === "memos" && page === "memo") || (section === "systems" && (page === "activity" || page === "reference"));
